...
//        }
        ...
        Recognition recognition = new Recognition(new VCodeTrain(
        ...
        List<Mat> toRecogs = recognition.getTraining().process(test, new SegMultiColor());
        for(Mat toRecog : toRecogs)
        {
            System.out.println(recognition.recognize(toRecog,10));
        }
